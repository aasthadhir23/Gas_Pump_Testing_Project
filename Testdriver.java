...
public class Testdriver {
	...
	public static void main(String[] args) {
		...
		while(true){  
			...
			String str = sc.next();
				...
				case "9":
					System.out.println("GasPump class");
					System.out.println("Midgrade() method\n");
					return_value = GP.Midgrade();
					System.out.println("The value returned by the method is:" + return_value + "\n");
					System.out.println("*******************************************************\n");
					break;
				...
				case "a":
					System.out.println("GasPump class");
					System.out.println("Show_Values() testing-related method\n");
					GP.Show_Values();
					System.out.println("*******************************************************\n");
					break;
	...
	public static void print_menu(){
		...
		System.out.println("9.  Midgrade");
		System.out.println("10. StartPump");
		System.out.println("11. Pump");
